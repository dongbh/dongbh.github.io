...
1. Option 2: Connect to the box using the type-c cable, RKDevTool will show as an "Found one ADB device", click "Switch", the box will restart, wait a moment and it will show "Found one Loader Device", click "Advanced Function" tab, and then click "Go Maskrom". 
  ![from adb to loader](../res/dsgw-210-7.png)
  ![from loader to maskrom](../res/dsgw-210-8.png)
